...
# my solver for experiments only
def bao_lsa_solve(costs):
    """I want to take multiple matching into account - this method is only for my experiments"""
    rids, cids = np.where(~np.isnan(costs))
    return rids, cids
